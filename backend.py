...
"""
    ...
    response = llm.invoke([
        SystemMessage(content="You are an expert travel planner. Focus on accurate pricing and seasonal constraints."),
...
"""
    ...
    response = llm.invoke([
        SystemMessage(content="You are a professional AI travel booking assistant. Focus on accuracy."),
